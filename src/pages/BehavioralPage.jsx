          ...
          <div style={styles.container}>
            ...
            <div style={{ display: "flex", gap: 12, marginBottom: 12 }}>
              ...
              <div style={{ flex: 1 }}>
                <div style={{ marginBottom: 12 }}>
                  <TrendChart title="Typing Variability" data={sampleTyping} dataKey="value" color="#60a5fa" />
                </div>
                <TrendChart title="Sleep Duration" data={sampleSleep} dataKey="value" color="#34d399" />
              </div>
            </div>
            ...
            <div style={styles.grid}>
              <div style={styles.card}>
                ...
                <div style={styles.placeholder}>Placeholder for timeline of recorded sessions and notable events.</div>
              </div>

              <div style={styles.card}>
                <div style={styles.cardTitle}>Activity Overview</div>
                <div style={styles.placeholder}>Placeholder for activity summary and quick KPIs.</div>
              </div>

              <div style={styles.card}>
                <div style={styles.cardTitle}>Keystroke Patterns</div>
                <div style={styles.placeholder}>Placeholder for raw keystroke heatmap and gaps.</div>
              </div>

              <div style={styles.card}>
                <div style={styles.cardTitle}>Notes</div>
                <div style={styles.placeholder}>Placeholder for analyst notes and annotations.</div>
              </div>
            </div>
          </div>
        );
